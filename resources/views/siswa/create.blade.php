...
<body class="bg-gradient-to-br from-pink-50 via-white to-pink-100">
    ...
    <div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-4xl font-bold bg-gradient-to-r from-pink-600 to-pink-500 bg-clip-text text-transparent mb-2">Tambah Data Siswa</h1>
                <p class="text-gray-600">Lengkapi formulir di bawah untuk menambahkan siswa baru</p>
            </div>
                    ...
                    <div class="px-8 py-8 bg-gradient-to-r from-pink-50 via-white to-pink-50 border-b border-pink-100">
                        ...
                        <div class="flex flex-col sm:flex-row items-start gap-8">
                            ...
                            <div class="flex-shrink-0">
                                <img id="preview"
                                     src="https://ui-avatars.com/api/?name=Preview&size=150&background=fce7f3&color=ec4899"
                                     alt="Preview"
                                     class="w-32 h-32 rounded-2xl object-cover border-4 border-pink-200 shadow-md">
                            </div>
                            <!-- Upload Input -->
                            <div class="flex-1">
                                <label class="block text-sm font-bold text-gray-700 mb-3">Upload Foto</label>
                                <input type="file"
                                       name="foto"
                                       id="foto"
                                       accept="image/*"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="alamat"
                                              ...
                                              class="w-full px-4 py-3 border border-pink-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all duration-200 @error('alamat') border-red-300 @enderror">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                    <p class="mt-1 text-sm text-red-600">
                                        <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                                    </p>
