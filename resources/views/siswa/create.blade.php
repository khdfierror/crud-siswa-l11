    ...
    <div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Data Siswa</h1>
                    ...
                    <div class="px-6 py-6 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
                        ...
                        <div class="flex items-start gap-6">
                            ...
                            <div class="flex-shrink-0">
                                <img id="preview"
                                     src="https://ui-avatars.com/api/?name=Preview&size=150&background=e5e7eb&color=6b7280"
                                     alt="Preview"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="alamat"
                                              ...
                                              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('alamat') border-red-300 @enderror">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                    <p class="mt-1 text-sm text-red-600">
                                        <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                                    </p>
